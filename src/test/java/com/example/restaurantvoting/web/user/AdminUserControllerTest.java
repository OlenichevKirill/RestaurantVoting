...
import static com.example.restaurantvoting.web.user.AdminUserController.REST_URL;
import static com.example.restaurantvoting.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
import static com.example.restaurantvoting.web.user.UserTestData.NOT_FOUND;
import static com.example.restaurantvoting.web.user.UserTestData.USER_ID;
import static com.example.restaurantvoting.web.user.UserTestData.USER_MAIL;
import static com.example.restaurantvoting.web.user.UserTestData.USER_MATCHER;
import static com.example.restaurantvoting.web.user.UserTestData.admin;
import static com.example.restaurantvoting.web.user.UserTestData.getNew;
import static com.example.restaurantvoting.web.user.UserTestData.getUpdated;
import static com.example.restaurantvoting.web.user.UserTestData.guest;
import static com.example.restaurantvoting.web.user.UserTestData.jsonWithPassword;
import static com.example.restaurantvoting.web.user.UserTestData.user;
