...
import com.example.restaurantvoting.util.exception.AppException;
import com.example.restaurantvoting.util.exception.ErrorType;
...
import static com.example.restaurantvoting.util.exception.ErrorType.APP_ERROR;
import static com.example.restaurantvoting.util.exception.ErrorType.BAD_DATA;
import static com.example.restaurantvoting.util.exception.ErrorType.BAD_REQUEST;
import static com.example.restaurantvoting.util.exception.ErrorType.DATA_CONFLICT;
import static com.example.restaurantvoting.util.exception.ErrorType.FORBIDDEN;
import static com.example.restaurantvoting.util.exception.ErrorType.NOT_FOUND;
import static com.example.restaurantvoting.util.exception.ErrorType.UNAUTHORIZED;
